...
<tr><td> <em>Generated: </em> 3/6/2023 11:50:11 PM</td></tr>
...
<tr><td> <em>Response:</em> <p>By using /joinroom command the messages are only being sent to clients that<br>joined the room. So if the client is not in the room then<br>they wouldn&#39;t be able to receive messages. Using the command /createroom, it creates<br>a room by the user and when another user types /joinroom, the user<br>is able to join the room that was created and viscera. This leads<br>to everyone that is inside the room being able to send and receive<br>messages.<br><br></p><br></td></tr>
</table></td></tr>
